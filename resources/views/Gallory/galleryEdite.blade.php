...
<section class="min-h-[70vh] flex items-center justify-center px-6 py-20 bg-zinc-950 relative overflow-hidden">
    ...
    <div class="relative w-full max-w-md">
        ...
        <div class="relative bg-zinc-900 border border-zinc-800 rounded-3xl p-8 shadow-2xl">
            ...
            <form class="flex flex-col gap-4" action="{{ route('gallory.update' ,  $gallory->id )  }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')

                {{-- Name Input --}}
                <div class="relative group">
                    <input type="text" name="name" value="{{ old('name', $gallory->name) }}" placeholder=" " 
                ...
                <label for="image-upload"
                    ...
                    <input id="image-upload" type="file" name="image" value="{{ old('image',  $gallory->image ) }}"  class="hidden"/>
                </label>
